...
import { InvestmentReportContent } from '@/nodes/components/investment-report-content';
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden relative bg-background">
      ...
      <main 
        ...
        style={showInvestmentReport ? {
          left: !isLeftCollapsed ? `${leftSidebarWidth}px` : '0px',
          right: '0px',
          top: '40px', // Top bar height
          bottom: '0px',
          zIndex: 40 // Cover everything except top bar
        } : {
          left: !isLeftCollapsed ? `${leftSidebarWidth}px` : '0px',
      ...
      >
        {showInvestmentReport ? (
          <div className="h-full w-full overflow-y-auto">
            <InvestmentReportContent outputNodeData={outputNodeData} />
          </div>
        ) : (
          <>
      ...
      <div className={cn(
        "absolute top-0 left-0 z-50 h-full transition-transform",
      ...
      <div className={cn(
        ...
        (isRightCollapsed || showInvestmentReport) && "transform translate-x-full opacity-0"
      )}>
        <RightSidebar
      ...
      <div 
        className={cn(
          ...
          (isBottomCollapsed || showInvestmentReport) && "transform translate-y-full opacity-0 pointer-events-none"
        )}
