from app.backtesting.output import OutputBuilder
...
def test_results_builder_builds_rows_and_summary(monkeypatch, portfolio):
    ...
    monkeypatch.setattr("app.backtesting.output.format_backtest_row", fake_format_backtest_row)
    monkeypatch.setattr("app.backtesting.output.print_backtest_results", fake_print_backtest_results)
