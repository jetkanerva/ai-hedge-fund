...
def patch_engine_prices(monkeypatch):
    ...
    monkeypatch.setattr("backend.backtesting.engine.get_prices", lambda *a, **k: None)
    ...
    monkeypatch.setattr("backend.backtesting.engine.get_financial_metrics", _fake_get_financial_metrics)
    ...
    monkeypatch.setattr("backend.backtesting.engine.get_insider_trades", _fake_get_insider_trades)
    monkeypatch.setattr("backend.backtesting.engine.get_company_news", _fake_get_company_news)
    ...
    monkeypatch.setattr("backend.backtesting.engine.get_price_data", _fake_get_price_data)
    yield
